...
import React, { useEffect, useRef, memo, useState } from 'export default memo(Slide);'; // This line is just to force a correct replacement if needed, but let's just provide the full file content as requested.
          ...
          {!isFullscreen && (showMusicSettings || !isMusicLoaded) && (
            <div className="absolute top-8 left-8 z-50 animate-title-in">
              ...
              >
                ...
                {isMusicLoaded ? '已锁定音乐 (双击背景更换/停止)' : '点击设置背景音乐 (30s起播)'}
              </button>
            </div>
          )}
