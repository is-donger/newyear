...
const mainSlides: SlideData[] = [
  ...
  { 
    ...
    type: 'soup', 
    content: [
      "全体成员分为4个大组，各组经内部讨论确定一种化学物质后，派出代表上台。",
      "其余小组轮流向代表提问，率先猜出代表所想物质的小组积1分，最终积分最高的小组胜出。",
...
const yuandanQuestions: QuestionData[] = [
  ...
  { q: "世界上最早开始庆祝元旦的国家或者地区是哪里？", a: "汤加（大洋洲）", img: "https://images.unsplash.com/photo-1610214434778-9585694285df?q=80&w=1000&auto=format&fit=crop" }
];
...
const tiyuQuestions: QuestionData[] = [
  ...
  { q: "奥运会的五环标志，分别代表哪个大洲？", a: "蓝（欧洲）、黑（非洲）、红（美洲）、黄（亚洲）、绿（大洋洲）", img: "https://images.unsplash.com/photo-1569512046602-06900223f114?q=80&w=1000&auto=format&fit=crop" },
...
const creditsSlide: SlideData = { 
  ...
  type: 'credits', 
  content: [
    "主持人：王蓦然、蔡咏辰", "活动策划：王蓦然", "活动审核：李安琪老师", "PPT制作：周子栋", 
    "编排排版：王蓦然", "摄影师：李安琪老师、班级同学", "场地策划：李安琪老师、王蓦然",
    "后勤部：家委及志愿者", "经济支持：李安琪老师、家委", "板报设计：文艺委员、宣传委员、全体志愿同学",
    "活动类裁判：王蓦然、袁芷琪、张瑞琥", "纪律管理：刘权锐、林灏", "道具组：李安琪老师、家委",
    "意见征集：黄月莹、蔡咏辰", "灵感提供：仲泽晨、蔡咏辰", "", "致谢",
    "感谢李安琪老师，家委，高一1班全体学生", "特别鸣谢：高一7班"
  ]
};
